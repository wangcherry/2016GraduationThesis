      ...
      <div class="xs">
        ...
        <div class="tab-content">
          <div class="tab-pane active" id="horizontal-form">
            <form class="form-horizontal" method="post" action="<%=basePath%>admin/changePassword.do">
              <div class="form-group">
                <label for="focusedinput" class="col-sm-2 control-label">请输入原始密码</label>
                <div class="col-sm-8">
                  <input type="text"  name="oldpassword" class="form-control1" id="oldpassword" placeholder="请输入原始密码">
                </div>
                <div class="col-sm-2">
                ...
                <div class="form-group">
                <label for="focusedinput" class="col-sm-2 control-label">请输入新密码</label>
                <div class="col-sm-8">
                  <input type="text"  name="newpassword" class="form-control1" id="newpassword" placeholder="请输入新密码">
                </div>
                </div>
                <div class="form-group">
                <label for="focusedinput" class="col-sm-2 control-label">请再次输入密码</label>
                <div class="col-sm-8">
                  <input type="text"  name="twopassword" class="form-control1" id="twopassword" placeholder="请再次输入密码">
                </div>
                </div>
                <!--<div class="col-sm-2">
...
<script type="text/javascript">
  window.onload=function(){
    ...
    alert("测试");
      ...
      xhr.open("POST","${pageContext.request.contextPath}/admin/isPasswordTrue.do?time="+new Date().getTime());
